...
<template>
  <div class="flex items-center py-4 lg:py-8 px-2 lg:px-4 border border-solid border-slate-200 rounded-2xl gap-x-4">
    ...
    <div
      ...
      :style="{
        color: coin.change24h > 0 ? '#5ac820' : 'red',
      }"
    >
      {{ `${coin.change24h > 0 ? '+' : ''}${coin.priceChangePercent}%` }}
    </div>
  </div>
</template>
