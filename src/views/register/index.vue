            ...
            <div class="border-2 border-[#76E43B] p-4 px-10 lg:py-10 lg:px-16 rounded-xl space-y-4">
              ...
              <template v-else>
                ...
                <div class="flex items-center gap-x-2">
                  <NIcon v-if="!/^.{8,32}$/.test(formData.password)" class="text-xl text-red-500">
                    <ErrorCircle16Filled />
                  </NIcon>
                  <NIcon v-else class="text-xl text-green-500">
                    <CheckmarkCircle16Filled />
                  </NIcon>
                  长度为8-32个字符
                </div>
                <div class="flex items-center gap-x-2">
                  <NIcon v-if="!/.*[a-z].*/.test(formData.password)" class="text-xl text-red-500">
                    <ErrorCircle16Filled />
                  </NIcon>
                  <NIcon v-else class="text-xl text-green-500">
                    <CheckmarkCircle16Filled />
                ...
                <div class="flex items-center gap-x-2">
                  <NIcon v-if="!/.*\d.*/.test(formData.password)" class="text-xl text-red-500">
                    <ErrorCircle16Filled />
                  </NIcon>
                  <NIcon v-else class="text-xl text-green-500">
                    <CheckmarkCircle16Filled />
                ...
                <div class="flex items-center gap-x-2">
                  <NIcon v-if="!/.*[^\w\s].*/.test(formData.password)" class="text-xl text-red-500">
                    <ErrorCircle16Filled />
                  </NIcon>
                  <NIcon v-else class="text-xl text-green-500">
                    <CheckmarkCircle16Filled />
